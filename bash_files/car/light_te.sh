...
python3 -m src.main  --base_dir '/home/aka225/scratch/outputs' \
                    --train \
                    --dataset 'pascal' \
                    --checkpoint_dir '/home/aka225/scratch/outputs/car_light_te' \
                    --objective_to_optimize 'text_embedding' \
                    --object_name 'car' \
                    --part_names 'background' 'light' \
                    ...
                    --crop_margin 10 \
                    --crop_threshold 0.2 \
                    --train_data_ids 0 1 2 3 4 5 6 7 9 10 \
                    --val_data_ids 11 14 16 17 18 19 20 21 24 25 \
